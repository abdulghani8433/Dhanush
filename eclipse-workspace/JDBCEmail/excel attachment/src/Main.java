...
public class Main {
    ...
    public static String writeResultSet(ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            stBuffer.append("<tr>");
            stBuffer.append("<td>" +resultSet.getString("stid")+"</td>");
            stBuffer.append("<td>" +resultSet.getString("stdname")+"</td>");
            stBuffer.append("<td>" +resultSet.getString("stdemail")+"</td>");
            stBuffer.append("<td>" +resultSet.getString("stdno")+"</td>");
            stBuffer.append("</tr>");
        }
